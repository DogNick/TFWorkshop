    ...
    "generate":[
        ...
        },
        {
            "cvaeattn2-weibo-bought":{
				...
				"max_out":20,
				"max_res":60,
				"beam_splits":[6,6,6,6,6,6,6,6,6]
			},
			"cvaeattn2-512-weibo-bought":{
				"tf_server":"0.0.0.0:10014",
				"deploy_gpu":6,
				"max_in":15,
				"max_out":20,
				"max_res":60,
			...
			"news2s-weibo-bought_reverse":{
				"tf_server":"0.0.0.0:10015",
				"deploy_gpu":7,
				"variants":"score",
				"lmda":0.4,
				"alpha":0.6,
    ...
    "intent":[
        {
            ...
            "tianchuan_cnn_tag":{"tf_server":"0.0.0.0:10041","deploy_gpu":1},
        }
    ],
	"chaten":[
        {
