...
confs["news2s-opensubtitle_gt3"].beam_splits          = [10,10,10,10,10,10,10]#[4,4,4,4,4,4,4,4,4,4]#[8,8,8,8,8,8,8,8,8]#[6,6,6,6,6,6,6,6]#test[2,2,2,2,2,2,2,2] 
...
confs["news2s-opensubtitle_gt3_joint_prime"] = copy.deepcopy(confs["vae"])
confs["news2s-opensubtitle_gt3_joint_prime"].model_kind           = "AttnS2SNewDecInit"
confs["news2s-opensubtitle_gt3_joint_prime"].input_vocab_size     = 8000 
confs["news2s-opensubtitle_gt3_joint_prime"].output_vocab_size    = 8000 
confs["news2s-opensubtitle_gt3_joint_prime"].lr_check_steps       = 150 
confs["news2s-opensubtitle_gt3_joint_prime"].embedding_size       = 200
confs["news2s-opensubtitle_gt3_joint_prime"].lr_keep_steps        = 80000  
confs["news2s-opensubtitle_gt3_joint_prime"].learning_rate        = 0.0001
confs["news2s-opensubtitle_gt3_joint_prime"].learning_rate_decay_factor = 1.0 
confs["news2s-opensubtitle_gt3_joint_prime"].batch_size           = 128 
confs["news2s-opensubtitle_gt3_joint_prime"].cell_model           = "LSTMCell"
confs["news2s-opensubtitle_gt3_joint_prime"].data_dir             = "/search/odin/Nick/GenerateWorkshop/data/opensubtitle_gt3_joint_prime"
#confs["news2s-opensubtitle_gt3_joint_prime"].embedding_init       = "/search/odin/Nick/GenerateWorkshop/data/opensubtitle_gt3/opensubtitle_filter2k.w2v.npy"
confs["news2s-opensubtitle_gt3_joint_prime"].input_max_len        = 35 
confs["news2s-opensubtitle_gt3_joint_prime"].output_max_len       = 35 
confs["news2s-opensubtitle_gt3_joint_prime"].opt_name             = "Adam" 
confs["news2s-opensubtitle_gt3_joint_prime"].lam                  = 0.0 
confs["news2s-opensubtitle_gt3_joint_prime"].beam_splits          = [6,6,6,6,6,6,6,6,6,6]#[4,4,4,4,4,4,4,4,4,4]#[8,8,8,8,8,8,8,8,8]#[6,6,6,6,6,6,6,6]#test[2,2,2,2,2,2,2,2] 
confs["news2s-opensubtitle_gt3_joint_prime"].use_data_queue       = False
confs["news2s-opensubtitle_gt3_joint_prime"].addmem               = True 
confs["news2s-opensubtitle_gt3_joint_prime"].attention            = "Luo"
...
confs["news2s-opensubtitle_gt3_joint_reverse"] = copy.deepcopy(confs["vae"])
confs["news2s-opensubtitle_gt3_joint_reverse"].model_kind           = "AttnS2SNewDecInit"
confs["news2s-opensubtitle_gt3_joint_reverse"].input_vocab_size     = 8000 
confs["news2s-opensubtitle_gt3_joint_reverse"].output_vocab_size    = 8000 
confs["news2s-opensubtitle_gt3_joint_reverse"].lr_check_steps       = 150 
confs["news2s-opensubtitle_gt3_joint_reverse"].embedding_size       = 200
confs["news2s-opensubtitle_gt3_joint_reverse"].lr_keep_steps        = 80000  
confs["news2s-opensubtitle_gt3_joint_reverse"].learning_rate        = 0.0001
confs["news2s-opensubtitle_gt3_joint_reverse"].learning_rate_decay_factor = 1.0 
confs["news2s-opensubtitle_gt3_joint_reverse"].batch_size           = 128 
confs["news2s-opensubtitle_gt3_joint_reverse"].cell_model           = "LSTMCell"
confs["news2s-opensubtitle_gt3_joint_reverse"].data_dir             = "/search/odin/Nick/GenerateWorkshop/data/opensubtitle_gt3_joint_prime"
confs["news2s-opensubtitle_gt3_joint_reverse"].input_max_len        = 35 
confs["news2s-opensubtitle_gt3_joint_reverse"].output_max_len       = 35 
confs["news2s-opensubtitle_gt3_joint_reverse"].opt_name             = "Adam" 
confs["news2s-opensubtitle_gt3_joint_reverse"].lam                  = 0.0 
confs["news2s-opensubtitle_gt3_joint_reverse"].beam_splits          = [6,6,6,6,6,6,6,6,6,6,6,6,6]#[4,4,4,4,4,4,4,4,4,4]#[8,8,8,8,8,8,8,8,8]#[6,6,6,6,6,6,6,6]#test[2,2,2,2,2,2,2,2] 
confs["news2s-opensubtitle_gt3_joint_reverse"].use_data_queue       = False
confs["news2s-opensubtitle_gt3_joint_reverse"].addmem               = False 
...
confs["news2s-noinit-opensubtitle_gt3"].beam_splits          = [6,6,6,6,6,6,6,6,6,6]#[4,4,4,4,4,4,4,4,4,4]#[8,8,8,8,8,8,8,8,8]#[6,6,6,6,6,6,6,6]#test[2,2,2,2,2,2,2,2] 
