...
__all__ = [
    ...
    "CustomHelper",
    "ScheduledEmbeddingTrainingHelperNameScope",
...
class ScheduledEmbeddingTrainingHelperNameScope(TrainingHelper):
  ...
  def __init__(self, inputs, sequence_length, embedding, sampling_probability,
               out_proj=None, time_major=False, seed=None, scheduling_seed=None, name=None):
    """Initializer.
    ...
    with ops.name_scope(name, "ScheduledEmbeddingSamplingWrapper",
      ...
      self._sampling_probability = ops.convert_to_tensor(sampling_probability, name="sampling_probability")
  ...
  def sample(self, time, outputs, state, name=None):
    with ops.name_scope(name, "SampleFeedAndId",
                        [time, outputs, state]):
      ...
      # Nick 
      if self._out_proj:
          logits = math_ops.matmul(outputs, self._out_proj[0]) + self._out_proj[1] 
  ...
  def next_inputs(self, time, outputs, state, sample_ids, name=None):
    with ops.name_scope(name, "CollectNextInputs",
...
class GreedyEmbeddingHelper(Helper):
  ...
  """
  # Nick add out_proj
  def __init__(self, embedding, start_tokens, end_token, out_proj):
    """Initializer.
