...
import attention_wrapper1_2 as attention_wrapper
...
AttentionWrapper = attention_wrapper.AttentionWrapper
...
class BasicDecoder(decoder.Decoder):
  ...
  def __init__(self, cell, helper, initial_state=None, output_layer=None):
  ...
  def state_shape(self):
      if isinstance(self._cell, AttentionWrapper):
  ...
  def initialize(self, name=None):
    ...
    self._initial_state = self._cell.zero_state(self.batch_size, tf.float32) if self._initial_state == None else self._initial_state
