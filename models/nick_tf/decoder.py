...
def dynamic_decode(decoder,
  ...
  with variable_scope.variable_scope(scope or "decoder") as varscope:
    ...
    # Nick put zero_outputs into step decoder itself
    zero_outputs = decoder.zero_outputs
    ...
    def body(time, outputs_ta, state, inputs, finished):
      ...
      #z_outputs = nest.map_structure(lambda a:tf.Print(a, [tf.shape(a)], message=str(a)+"_zout"), zero_outputs) 
      #n_outputs = nest.map_structure(lambda a:tf.Print(a, [tf.shape(a)], message=str(a)+"_nout"), next_outputs) 
      ...
      def _maybe_copy_state(new, cur):
        ...
        if isinstance(cur, tensor_array_ops.TensorArray):
          ...
          if len(cur.shape) <= 2:
            next_shape = [None] + list(cur.shape[1:])
          else:
    ...
    res = control_flow_ops.while_loop(
        ...
        shape_invariants=[
            ...
            decoder.state_shape,
            initial_inputs.shape,
            initial_finished.shape 
        ],
